...
app = Flask(__name__)
app.secret_key = '123'  # Ubah 'your_secret_key' dengan string yang lebih rumit dan aman
...
def upload_file():
    ...
    if file:
        ...
        # Simpan hasil prediksi dan path gambar ke dalam sesi Flask
...
def result():
    ...
    # Bersihkan sesi setelah mendapatkan nilai untuk mencegah tampilan ulang saat refresh
